...
const DataSheet = dynamic(() => import("react-datasheet"), { ssr: false });
// const DragDropContextProvider = dynamic(() =>
//   import('react-dnd').then((mod) => mod.DragDropContextProvider),
//   { ssr: false }
// );
...
class DragDropPage extends PureComponent {
  constructor (props) {
    super(props)
    this.state = {
      columns: [
